...
public class EnemyShipBehaviour extends EnemyBehaviour
{
    ...
    private void shoot()
    {
        ...
        MovingObject bullet = new MovingObject(this.parent.name() + "_bullet" + Integer.toString(this.bulletID++), this.parent.transform().clone(), new ColliderCircle(new Point(0,0), 3), new BulletBehaviour(this), new Point(0,0), BULLET_SPEED, 1);
